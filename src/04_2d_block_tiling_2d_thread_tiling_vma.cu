...
>
__global__ void gemm_v04_vectorized(size_t m, size_t n, size_t k,
                            const T alpha,
                            ...
                            T *C, size_t ldc)
{
    ...
    // check if an integer number of vector can fit into B_tmp
    ...
    {   
        ...
        {   
            ...
            // load necessary B data with vma
            #pragma unroll
...
template void launch_gemm_kernel_v04_vectorized<float>(size_t m, size_t n, size_t k,
                                   const float *alpha,
...
template void launch_gemm_kernel_v04_vectorized<double>(size_t m, size_t n, size_t k,
                                    const double *alpha,
...
template void launch_gemm_kernel_v04_vectorized<__half>(size_t m, size_t n, size_t k,
                                    const __half *alpha,
