...
>
__global__ void gemm_v03_vectorized(size_t m, size_t n, size_t k,
                            const T alpha,
...
{   
    ...
    gemm_v03_vectorized<T, BLOCK_TILE_SIZE_M, BLOCK_TILE_SIZE_N, BLOCK_TILE_SIZE_K, THREAD_TILE_SIZE_M>
...
template void launch_gemm_kernel_v03_vectorized<float>(size_t m, size_t n, size_t k,
                                   const float *alpha,
...
template void launch_gemm_kernel_v03_vectorized<double>(size_t m, size_t n, size_t k,
                                    const double *alpha,
...
template void launch_gemm_kernel_v03_vectorized<__half>(size_t m, size_t n, size_t k,
                                    const __half *alpha,
